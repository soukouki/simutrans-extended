...
public:
	terraformer_t(terraformer_t::operation_t op, karte_t *world);
...
private:
	 ...
	 */
	const char *can_raise_tile_to(const node_t &node, const player_t *player, bool allow_deep_water, bool keep_water) const;
	 ...
	 */
	const char *can_lower_tile_to(const node_t &node, const player_t *player, bool allow_deep_water) const;
