...
void settings_extended_revenue_stats_t::init( settings_t *sets )
{
	...
	INIT_NUM( "max_alternative_destinations_visiting", sets->get_max_alternative_destinations_visiting(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM( "max_alternative_destinations_commuting", sets->get_max_alternative_destinations_commuting(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM( "max_alternative_destinations_per_visitor_demand_millionths", sets->get_max_alternative_destinations_per_visitor_demand_millionths(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM( "max_alternative_destinations_per_job_millionths", sets->get_max_alternative_destinations_per_job_millionths(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM("min_alternative_destinations_visiting", sets->get_min_alternative_destinations_visiting(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false);
	INIT_NUM("min_alternative_destinations_commuting", sets->get_min_alternative_destinations_commuting(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false);
	INIT_NUM("min_alternative_destinations_per_visitor_demand_millionths", sets->get_min_alternative_destinations_per_visitor_demand_millionths(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false);
	INIT_NUM("min_alternative_destinations_per_job_millionths", sets->get_min_alternative_destinations_per_job_millionths(), 0, UINT32_MAX_VALUE, gui_numberinput_t::AUTOLINEAR, false);
