...
map_button_t button_init[MAP_MAX_BUTTONS] = {
	...
	{ COL_LIGHT_PURPLE, COL_DARK_PURPLE, "Passengers", "Sum of visitors/commuters at halts", minimap_t::MAP_TRANSFER },
	{ COL_LIGHT_PURPLE, COL_DARK_PURPLE, "Handling mails", "The number of mails that handling at this stop", minimap_t::MAP_MAIL_HANDLING_VOLUME },
	{ COL_LIGHT_PURPLE, COL_DARK_PURPLE, "Handling goods", "The number of goods that handling at this stop", minimap_t::MAP_GOODS_HANDLING_VOLUME },
