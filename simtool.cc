...
const char *tool_build_land_chain_t::work( player_t *player, koord3d pos )
{
	...
	int rotation = (default_param  &&  default_param[2]!='#') ? (default_param[2]-'0') % fab->get_building()->get_all_layouts() : simrand(fab->get_building()->get_all_layouts()-1, "const char *tool_build_land_chain_t::work");
...
//		fab = factory_builder_t::get_random_consumer( false, (climate_bits)(1 << welt->get_climate( pos.get_2d() )), welt->get_timeline_year_month() );
	...
	int rotation = (default_param  &&  default_param[2]!='#') ? (default_param[2]-'0') % fab->get_building()->get_all_layouts() : simrand(fab->get_building()->get_all_layouts(), "const char *tool_build_factory_t::work");
	koord size = fab->get_building()->get_size(rotation);
